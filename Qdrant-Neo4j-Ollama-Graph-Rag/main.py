...
if __name__ == "__main__":
    ...
    data_file = os.getenv("DATA_FILE", "test1.txt")
    ...
    while True:
        ...
        print(f"Current Data File: {data_file}")
        print("=" * 50)
        ...
        if choice == "1":
            ...
            try:
                ...
                print(f"Error: {data_file} file not found. Please ensure the file exists in the current directory.")
