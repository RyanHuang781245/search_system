...
GRAPHRAG_SEMANTIC_SCORE_THRESHOLD = float(os.getenv("GRAPHRAG_SEMANTIC_SCORE_THRESHOLD", str(QDRANT_SCORE_THRESHOLD)))
...
GRAPHRAG_QUERY_ROUTER_MODE = os.getenv("GRAPHRAG_QUERY_ROUTER_MODE", "deterministic_first")
...
GRAPH_QUERY_PLANNER_MODE = os.getenv("GRAPH_QUERY_PLANNER_MODE", "deterministic_first")
GRAPH_QUERY_PLANNER_LLM_ENABLED = os.getenv("GRAPH_QUERY_PLANNER_LLM_ENABLED", "1").lower() in {"1", "true", "yes", "on"}
...
DEIDENTIFICATION_ENABLED = os.getenv("DEIDENTIFICATION_ENABLED", "False").lower() in {"1", "true", "yes", "on"}
DEIDENTIFICATION_SALT = os.getenv("DEIDENTIFICATION_SALT", "")
DEIDENTIFICATION_MAPPING_FILE = os.getenv("DEIDENTIFICATION_MAPPING_FILE", "")
